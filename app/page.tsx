...
<li><a href="#products">Pwodwi</a></li>  <li><a href="#contact">Kontakte</a></li>  
  </div>  
    </nav>  <section id="home"  
  style={{  
  ...
  >  
    ...
    >  
      <h3 style={{ color: "#166534", fontSize: "28px" }}>  
        🐐 Elvaj Kabrit  
      </h3>  <p style={{ marginTop: "15px", color: "#555" }}>  
...
>  
  <h2 style={{ fontSize: "40px", marginBottom: "20px" }}>  
    Kontakte Nou  
  </h2>    <p style={{ fontSize: "20px", marginBottom: "30px" }}>  
